        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div>
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                    class="w-full py-2.5 px-3 rounded-sm border border-blue-500 bg-gray-800 bg-opacity-65 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-white @error('name') border-red-500 @enderror"
