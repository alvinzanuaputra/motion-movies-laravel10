...
class WatchlistController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'movie_id.required' => 'Film tidak boleh kosong.',
            'movie_id.unique' => 'Film sudah ditambahkan sebelumnya.'
        ]);
        ...
        return redirect('/watchlist')->with('pesan', 'Film berhasil ditambahkan!');
    }
    ...
    public function destroyPivot($user_id, $movie_id)
    {
        ...
        return redirect('/watchlist')->with('pesan', 'Film berhasil dihapus!');
    }
}
